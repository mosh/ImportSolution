...
/**
 The `AWFMGLAnnotationView` class is a sublcass of `MGLAnnotationView` that supports annotation style and animation effects
 when rendered on a Mapbox map view.
 */
 ...
 */
@property (readonly, nonatomic, strong, nullable) AWFAnnotationStyle *style;
