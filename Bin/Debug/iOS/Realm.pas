...
type
  ...
  private
    ...
    method addNotificationBlock(&block: method(&array: Realm.RLMArray<__gp_64>; changes: Realm.RLMCollectionChange; error: NSError)): Realm.RLMNotificationToken; public;
    [NonSwiftOnly]
    method minOfProperty(&property: NSString): nullable id; public;
    [Alias]
    [SwiftOnly]
  ...
  Realm.RLMSyncAuthError = enum ([NonSwiftOnly] RLMSyncAuthErrorBadResponse = 1, [NonSwiftOnly] BadResponse = 1, [SwiftOnly] badResponse = 1, [NonSwiftOnly] RLMSyncAuthErrorBadRemoteRealmPath = 4, [NonSwiftOnly] BadRemoteRealmPath = 4, [SwiftOnly] badRemoteRealmPath = 4, RLMSyncAuthErrorHTTPStatusCodeError = 5, HTTPStatusCodeError = 5, [NonSwiftOnly] RLMSyncAuthErrorClientSessionError = 7, [NonSwiftOnly] ClientSessionError = 7, [SwiftOnly] clientSessionError = 7, [NonSwiftOnly] RLMSyncAuthErrorInvalidParameters = 13, [NonSwiftOnly] InvalidParameters = 13, [SwiftOnly] invalidParameters = 13, [NonSwiftOnly] RLMSyncAuthErrorMissingPath = 14, [NonSwiftOnly] MissingPath = 14, [SwiftOnly] missingPath = 14, [NonSwiftOnly] RLMSyncAuthErrorInvalidCredential = 15, [NonSwiftOnly] InvalidCredential = 15, [SwiftOnly] invalidCredential = 15, [NonSwiftOnly] RLMSyncAuthErrorUserDoesNotExist = 16, [NonSwiftOnly] UserDoesNotExist = 16, [SwiftOnly] userDoesNotExist = 16, [NonSwiftOnly] RLMSyncAuthErrorUserAlreadyExists = 17, [NonSwiftOnly] UserAlreadyExists = 17, [SwiftOnly] userAlreadyExists = 17, [NonSwiftOnly] RLMSyncAuthErrorAccessDeniedOrInvalidPath = 18, [NonSwiftOnly] AccessDeniedOrInvalidPath = 18, [SwiftOnly] accessDeniedOrInvalidPath = 18, [NonSwiftOnly] RLMSyncAuthErrorInvalidAccessToken = 19, [NonSwiftOnly] InvalidAccessToken = 19, [SwiftOnly] invalidAccessToken = 19, [NonSwiftOnly] RLMSyncAuthErrorExpiredPermissionOffer = 20, [NonSwiftOnly] ExpiredPermissionOffer = 20, [SwiftOnly] expiredPermissionOffer = 20, [NonSwiftOnly] RLMSyncAuthErrorAmbiguousPermissionOffer = 21, [NonSwiftOnly] AmbiguousPermissionOffer = 21, [SwiftOnly] ambiguousPermissionOffer = 21, [NonSwiftOnly] RLMSyncAuthErrorFileCannotBeShared = 22, [NonSwiftOnly] FileCannotBeShared = 22, [SwiftOnly] fileCannotBeShared = 22);
  ...
  private
    ...
    [NonSwiftOnly]
    method objectAtIndex(&index: NSUInteger): __gp_177; public;
    [Alias]
    [SwiftOnly]
    method object(&index: NSUInteger): __gp_177; public;
    method firstObject: __gp_177; public;
    method lastObject: __gp_177; public;
    [NonSwiftOnly]
    method indexOfObject(object: __gp_177): NSUInteger; public;
    [Alias]
    [SwiftOnly]
    method &index(object: __gp_177): NSUInteger; public;
    [NonSwiftOnly]
    method indexOfObjectWhere(predicateFormat: NSString; params Param1: {VOID}): NSUInteger; public;
    [Alias]
    [SwiftOnly]
    ...
    [SwiftOnly]
    method indexOfObject(predicate: NSPredicate): NSUInteger; public;
    method objectsWhere(predicateFormat: NSString; params Param1: {VOID}): Realm.RLMResults<__gp_177>; public;
    method objectsWhere(predicateFormat: NSString) args(args: va_list): Realm.RLMResults<__gp_177>; public;
    [NonSwiftOnly]
    method objectsWithPredicate(predicate: NSPredicate): Realm.RLMResults<__gp_177>; public;
    [Alias]
    [SwiftOnly]
    method objects(predicate: NSPredicate): Realm.RLMResults<__gp_177>; public;
    [NonSwiftOnly]
    method sortedResultsUsingKeyPath(keyPath: NSString) ascending(ascending: BOOL): Realm.RLMResults<__gp_177>; public;
    [Alias]
    [SwiftOnly]
    method sortedResults(keyPath: NSString) ascending(ascending: BOOL): Realm.RLMResults<__gp_177>; public;
    [NonSwiftOnly]
    method sortedResultsUsingDescriptors(properties: NSArray<Realm.RLMSortDescriptor>): Realm.RLMResults<__gp_177>; public;
    [Alias]
    [SwiftOnly]
    method sortedResults(properties: NSArray<Realm.RLMSortDescriptor>): Realm.RLMResults<__gp_177>; public;
    [NonSwiftOnly]
    method distinctResultsUsingKeyPaths(keyPaths: NSArray<NSString>): Realm.RLMResults<__gp_177>; public;
    [Alias]
    [SwiftOnly]
    method distinctResults(keyPaths: NSArray<NSString>): Realm.RLMResults<__gp_177>; public;
    method addNotificationBlock(&block: method(results: Realm.RLMResults<__gp_188>; change: Realm.RLMCollectionChange; error: NSError)): Realm.RLMNotificationToken; public;
    [NonSwiftOnly]
    method minOfProperty(&property: NSString): nullable id; public;
    [Alias]
    [SwiftOnly]
    ...
    method average(&property: NSString): nullable NSNumber; public;
    [NonSwiftOnly]
    method objectAtIndexedSubscript(&index: NSUInteger): __gp_177; public;
    [Alias]
    [SwiftOnly]
    method object(&index: NSUInteger): __gp_177; public;
    method init: instancetype; public;
  ...
  Realm.RLMSyncSubscriptionState = enum ([NonSwiftOnly] RLMSyncSubscriptionStateError = 23, [NonSwiftOnly] Error = 23, [SwiftOnly] error = 23, [NonSwiftOnly] RLMSyncSubscriptionStateCreating = 4, [NonSwiftOnly] Creating = 4, [SwiftOnly] creating = 4, [NonSwiftOnly] RLMSyncSubscriptionStatePending = 0, [NonSwiftOnly] Pending = 0, [SwiftOnly] pending = 0, [NonSwiftOnly] RLMSyncSubscriptionStateComplete = 1, [NonSwiftOnly] Complete = 1, [SwiftOnly] complete = 1, [NonSwiftOnly] RLMSyncSubscriptionStateInvalidated = 5, [NonSwiftOnly] Invalidated = 5, [SwiftOnly] invalidated = 5);
