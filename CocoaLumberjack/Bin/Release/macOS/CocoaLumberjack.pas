...
// Targets: arm64
// Dependent fx:rtl, Foundation, QuartzCore, AppKit, CoreGraphics
// Dependent libraries:
// Platform: macOS
// 
...
type
  ...
  public
    ...
    [NonSwiftOnly]
    method getRed(red: ^CGFloat) green(green: ^CGFloat) blue(blue: ^CGFloat) alpha(alpha: ^CGFloat);
    [Alias]
    [SwiftOnly]
    method get(red: ^CGFloat) green(green: ^CGFloat) blue(blue: ^CGFloat) alpha(alpha: ^CGFloat);
  end;
