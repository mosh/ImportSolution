...
@class AWFGraphSeries, AWFGraphAxis, AWFGraphCalloutView, AWFGraphLoadingView;
 ...
 */
@property (nonatomic, strong, nullable) AWFGraphSeries *series;
...
/**
*  The view containing the series items for the graph.
*/
@property (nonatomic, readonly) UIView *seriesContainerView;

/**
 *  The callout view used to display point values on graph gesture events.
 */
@property (nonatomic, readonly) AWFGraphCalloutView *calloutView;

/**
*  The callout position indicator when the callout is currently visible on the graph view.
*/
@property (nonatomic, readonly) CALayer *calloutPositionLine;

/**
*  The data loading indicator for the graph view.
*/
@property (nonatomic, readonly) AWFGraphLoadingView *loadingView;
 ...
 */
@property (nonatomic, weak, nullable) id<AWFGraphViewDelegate> delegate;
 ...
 */
- (nullable NSArray *)seriesItemsForRendererType:(AWFGraphRendererType)rendererType;
 ...
 */
- (nullable AWFGraphRenderer *)rendererForType:(AWFGraphRendererType)rendererType;
