...
/**
 ...
 [`alerts` endpoint](https://www.aerisweather.com/support/docs/api/reference/endpoints/alerts) of the Aeris API. All requests will
...
/**
 `AWFAdvisoriesSummaries` provides convenience methods for interacting with the
 [`alerts/summary` endpoint](https://www.aerisweather.com/support/docs/api/reference/endpoints/alerts_summary) of the Aeris API. All requests will
 return instances of `AWFAdvisorySummary` that will be populated by the data returned by the API unless otherwise indicated.
 */
