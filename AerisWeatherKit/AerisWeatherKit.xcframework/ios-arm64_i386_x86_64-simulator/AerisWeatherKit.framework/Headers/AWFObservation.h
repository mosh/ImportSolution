...
/**
 ...
 This value combines both the individual observation QC value and the overall confidence in the station and is equivalent
 to the QC code * station confidence.
 */
@property (nonatomic, assign) NSInteger trustFactor;
...
/**
 ...
 - 10: OK, passed QC
 */
@property (nonatomic, assign) NSInteger QCCode;
