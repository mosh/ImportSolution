...
@class AWFTileSource;
@protocol AWFPolygon, AWFPolyline;
 ...
 */
- (NSArray<NSObject<AWFPolygon> *> *)polygonsFromObjects:(NSArray<AWFGeographicObject *> *)objects;

/**
 Returns an array of polyline overlay objects for a series of `AWFGeographicObject` instances. These objects must have a valid polyline string or `AWFGeoPolygon`
 instance in order for a polyline to be created for it.

 @param objects An array of `AWFGeographicObject` instances to create polyline overlays for
 @return An array of polyline objects
 */
- (NSArray<NSObject<AWFPolyline> *> *)polylinesFromObjects:(NSArray<AWFGeographicObject *> *)objects;
 ...
 */
- (id)combinedOverlayForPolygons:(NSArray<id<AWFPolygon>> *)polygons polylines:(NSArray<id<AWFPolyline>> *)polylines;
