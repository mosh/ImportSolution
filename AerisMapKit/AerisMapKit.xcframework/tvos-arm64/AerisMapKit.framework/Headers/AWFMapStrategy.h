...
/**
 ...
 the same map delegates for the specific map SDK are also proxied to other map view delegates as necessary.
 */
...
/**
 ...
 @param annotation Annotation to return the default view for
 */
- (id)defaultAnnotationViewForAnnotation:(id)annotation;

/**
 Returns the default overlay renderer or layer for the specified overlay as configured and styled by the SDK. Note that
 not all mapping strategies support this method depending on how overlays are created and rendered by the third-party
 mapping library.

 @param overlay Overlay to return the renderer or layer for
 */
- (id)defaultRendererForOverlay:(id)overlay;
