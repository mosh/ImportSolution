 ...
 */
FOUNDATION_EXPORT NSString * const AWFRasterMapLayerWillChange;

/**
 Event triggered when a property on the map layer has changed.
 */
FOUNDATION_EXPORT NSString * const AWFRasterMapLayerDidChange;
...
/**
 ...
 @return An initialized raster layer object.
 */
- (instancetype)initWithLayerType:(AWFMapLayer)layerType forecastModel:(nullable AWFForecastModelType)forecastModel;
...
/**
 ...
 @return An initialized raster layer object.
 */
+ (instancetype)layerWithLayerType:(AWFMapLayer)layerType forecastModel:(nullable AWFForecastModelType)forecastModel;
...
/**
 ...
 @return An initialized raster layer object.
 */
+ (instancetype)layerWithLayerKey:(NSString *)layerKey;
...
/**
 ...
 @param layerKey The future raster layer key.
 */
+ (BOOL)futureLayerRequiresModel:(NSString *)layerKey;
