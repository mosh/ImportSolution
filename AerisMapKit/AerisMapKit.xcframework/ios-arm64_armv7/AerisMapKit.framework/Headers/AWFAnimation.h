...
/**
 ...
 @param animation The animation that updated its range.
 @param startDate The start date of the animation time range.
 @param endDate   The end date of the animation time range.
 */
- (void)animation:(AWFAnimation *)animation didUpdateStartDate:(NSDate *)startDate endDate:(NSDate *)endDate;
...
/**
 ...
 @param animation The animation that failed to perform the request
 @param data	  The request data parameters used with the request
 @param error	  The error that occurred
 */
- (void)animation:(AWFAnimation *)animation didFailToPerformRequestForData:(NSDictionary *)data error:(NSError *)error;
 ...
 */
- (void)animation:(AWFAnimation *)animation didUpdateLoadingProgress:(NSInteger)progress total:(NSInteger)total error:(nullable NSError *)error;
...
/**
 ...
 @param animation The animation whose loading progress failed
 @param error The error that occurred
 */
